...
import { Feather, FileText, Sparkles, Moon, Sun, Play, Pen, ExternalLink } from 'lucide-react';
        ...
        <div className="flex items-center space-x-3">
          ...
          <Show when='signed-in'>
            <div className='flex items-center justify-center gap-3'>
              <ModeToggle />
              <Button onClick={() => router.push('/user')} className='p-4 cursor-pointer'>Back to Dashboard</Button>
              <UserButton />
            </div>
          </Show>
        </div>
