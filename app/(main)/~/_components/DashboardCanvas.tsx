...
import Editor from '../_rich-text-editor/Editor';
        ...
        <header className="h-16 px-6 border-b border-border bg-background backdrop-blur-sm flex items-center justify-between z-20 shrink-0">
          ...
          <div className="flex items-center space-x-3 flex-1 max-w-xl">
            ...
            <input
              ...
              className="bg-transparent font-serif font-bold text-lg text-foreground border-b border-transparent hover:border-border focus:border-primary outline-none max-w-full transition-colors"
