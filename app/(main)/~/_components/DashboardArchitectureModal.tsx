...
export const DashboardArchitectureModal: React.FC<
  DashboardArchitectureModalProps
> = ({ isOpen, onClose }) => {
  const [activeTab, setActiveTab] = useState<
    "spatial" | "components" | "interactions" | "palette"
  >("spatial");
...
- LIGHT ORANGE (#f2e0d2):
  ...
  * Active document list item background in the sidebar.`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-[#2f2d32]/80 backdrop-blur-md animate-fadeIn">
      <div className="bg-[#2f2d32] border-2 border-[#f2e0d2]/20 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl text-[#f2e0d2] overflow-hidden">
        ...
        <div className="p-5 border-b border-[#f2e0d2]/10 flex items-center justify-between bg-[#2f2d32]">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              {copied ? (
                <Check className="w-3.5 h-3.5 text-[#d42710]" />
              ) : (
            ...
            <div className="space-y-6">
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-2">
                ...
                <p className="text-[#f2e0d2]/90 leading-relaxed">
                  The dashboard implements an isolated 100vh Flexbox layout
                  preventing document-level scrolling. The screen is partitioned
                  into three purposeful zones designed to minimize cognitive
                  fatigue and focus the creator's gaze on the central writing
                  canvas:
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono text-xs">
                <div className="p-4 rounded-xl bg-[#2f2d32] border border-[#f2e0d2]/15 space-y-2">
                  <div className="text-[#d42710] font-bold">
                    1. LEFT SIDEBAR
                  </div>
                  <div className="text-xl font-bold text-[#f2e0d2]">
                    280px (18-20%)
                  </div>
                  <p className="text-[#f2e0d2]/70 font-sans text-xs">
                    Collapsible navigation rail. Houses profile, workspaces,
                    document list, and quick creation. Collapses to 64px icon
                    rail for extra canvas width.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#f2e0d2] text-[#2f2d32] border border-[#f2e0d2] space-y-2 shadow-lg">
                  ...
                  <div className="text-xl font-bold text-[#2f2d32]">
                    Flex 1 (55-60%)
                  </div>
                  <p className="text-[#2f2d32]/80 font-sans text-xs">
                    Central sanctuary. Constrained to 68ch optical text column
                    to prevent eye strain. Expands to 100% in Zen Mode.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#2f2d32] border border-[#f2e0d2]/15 space-y-2">
                  ...
                  <p className="text-[#f2e0d2]/70 font-sans text-xs">
                    Right utility panel. Persistent Pomodoro timer, audio suite
                    (TTS/STT), and document-linked tasks. Collapses to 56px.
                  </p>
                </div>
              </div>

              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-2 font-mono text-xs">
                <span className="text-[#d42710] font-bold uppercase">
                  Zen Mode Layout Override:
                </span>
                <p className="text-[#f2e0d2]/80 font-sans text-xs">
                  When Zen Mode is triggered, the left sidebar and productivity
                  dock transition to{" "}
                  <code className="bg-[#2f2d32] px-1.5 py-0.5 rounded text-[#d42710]">
                    display: none; opacity: 0;
                  </code>
                  . The canvas expands to{" "}
                  <code className="text-[#f2e0d2]">100vw x 100vh</code> with a
                  warm paper backdrop, typewriter centering, and subtle floating
                  escape trigger.
                </p>
              </div>
            </div>
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-3">
                ...
                <ul className="space-y-2 text-xs font-sans text-[#f2e0d2]/90">
                  <li className="flex items-start space-x-2">
                    <span className="text-[#d42710] font-bold font-mono">
                      1.1
                    </span>
                    <span>
                      <strong>User Profile Widget:</strong> 36px squared avatar
                      with initials "R", workspace title (Elena Rostova), desk
                      badge (Investigative Desk), and dropdown for workspace
                      switching.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    ...
                    <span>
                      <strong>Folder & View Selector:</strong> All Documents,
                      Essays & Longform, Investigative Desk, Weekly Dispatch,
                      and Archive with live document count pills.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#d42710] font-bold font-mono">
                    ...
                    <span>
                      <strong>Active Drafts List:</strong> Scrollable list item
                      cards displaying draft title, last edited timestamp, and
                      word count tag with active document red dot indicator.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#d42710] font-bold font-mono">
                    ...
                    <span>
                      <strong>Bottom Quick Actions:</strong> Primary "+ New
                      Entry (⌘N)" Vivid Red button and sidebar collapse chevron
                      toggle.
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-3">
                ...
                <ul className="space-y-2 text-xs font-sans text-[#f2e0d2]/90">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>
                      <strong>Header & Document Meta:</strong> Inline title
                      editor, real-time word counter, character counter, and
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span>
                      <strong>Typography Engine:</strong> Quick toggle between
                      Serif (Playfair/Georgia), Sans (Inter/Plus Jakarta), and
                      Monospace with sizing steps (Normal, Large, Huge).
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#d42710] font-bold font-mono">
                    ...
                    <span>
                      <strong>Floating Formatting Strip:</strong> Markdown
                      shortcuts for H1, H2, Bold, Italic, Blockquote, Bullet
                      List, and Inline Code snippet.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#d42710] font-bold font-mono">
                    ...
                    <span>
                      <strong>Hyper-Focus Writing Area:</strong> Seamless
                      full-height textarea styled like premium literary bond
                      paper.
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-3">
                ...
                <ul className="space-y-2 text-xs font-sans text-[#f2e0d2]/90">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>
                      <strong>Persistent Pomodoro Bar:</strong> Large 32px
                      digital clock, sprint cycle dots (1-4), Focus/Pause
                      toggle, reset, and Work/Break automatic switching.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-[#d42710] font-bold font-mono">
                    ...
                    <span>
                      <strong>Speech-to-Text (STT) Module:</strong> Prominent
                      microphone button with live recording indicator, 7-band
                      bouncing audio equalizer waveform, and instant text
                      streaming.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    ...
                    <span>
                      <strong>Text-to-Speech (TTS) Proofreader:</strong>{" "}
                      Dedicated media player with Play/Pause, playback speed
                      selection pills (0.8x, 1.0x, 1.25x, 1.5x), and audio draft
                      synthesis.
                    </span>
                  </li>
                  <li className="flex items-start space-x-2">
                    ...
                    <span>
                      <strong>Linked Document Checklist:</strong> Progress bar,
                      quick task creation with High / Med / Low priorities, and
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-2">
                ...
                <p className="text-xs text-[#f2e0d2]/90 leading-relaxed font-sans">
                  Clicking "Start Voice Dictation" initiates the Web Speech API.
                  The microphone button shifts from neutral Orange to a vibrant
                  Vivid Red ring with an active pulse animation. 7 vertical
                  waveform equalizer bars animate to simulate acoustic
                  amplitude. Transcribed text is appended in real time into the
                  active cursor position in the canvas.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-2">
                ...
                <p className="text-xs text-[#f2e0d2]/90 leading-relaxed font-sans">
                  When the Pomodoro countdown drops below 01:00, the widget card
                  transitions to a glowing Vivid Red background overlay (
                  <code className="text-[#d42710]">bg-[#d42710]/20</code>) with
                  a pulsing text glow. Upon reaching 00:00, the timer
                  auto-increments the completed sprint counter and prompts a
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-2">
                ...
                <p className="text-xs text-[#f2e0d2]/90 leading-relaxed font-sans">
                  Activating Zen Mode causes a 500ms opacity transition that
                  fades out the Left Sidebar, Top Navigation, and Productivity
                  Dock. The canvas expands to 100% viewport dimensions. Moving
                  the cursor gently reveals a floating top-right "ESC to Exit"
                  pill, allowing effortless exit.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10 space-y-2">
                ...
                <p className="text-xs text-[#f2e0d2]/90 leading-relaxed font-sans">
                  Every keystroke triggers an asynchronous debounce handler
                  updating local document memory. A quiet status indicator
                  displays "Auto-saved to local memory" alongside word counts.
                  Clicking the Copy icon instantly morphs into a checkmark icon
                  with a 2-second confirmation timeout.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-5">
              <div className="p-4 rounded-xl bg-[#f2e0d2]/5 border border-[#f2e0d2]/10">
                ...
                <p className="text-xs text-[#f2e0d2]/80 font-sans leading-relaxed">
                  Every pixel on the /dashboard is strictly mapped to one of the
                  three designated hex codes. No arbitrary purple gradients,
                  cyan highlights, or unrequested secondary hues are permitted.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#2f2d32] border-2 border-[#d42710] space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-mono font-black text-sm text-[#d42710]">
                      VIVID RED (#d42710)
                    </span>
                  </div>
                ...
                <ul className="list-disc list-inside text-xs font-sans text-[#f2e0d2]/90 space-y-1 pt-1">
                  <li>
                    Active document selection indicator dot and word count
                    metric callouts.
                  </li>
                  <li>Primary "+ New Entry" and "+ Focus" action buttons.</li>
                  <li>
                    Microphone recording pulse indicator and animated audio
                    waveform bars.
                  </li>
                  <li>
                    Urgent Pomodoro countdown highlight when &lt; 1 minute
                    remains.
                  </li>
                  <li>
                    Completed task checkmark state and high-priority task tags.
                  </li>
              ...
              <div className="p-4 rounded-xl bg-[#2f2d32] border border-[#f2e0d2]/20 space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-mono font-black text-sm text-[#f2e0d2]">
                      DARK GREY (#2f2d32)
                    </span>
                  </div>
                ...
                <ul className="list-disc list-inside text-xs font-sans text-[#f2e0d2]/90 space-y-1 pt-1">
                  ...
                  <li>
                    Primary typography and headings rendered across the main
                    light canvas.
                  </li>
                  <li>Zen mode exit floating badge background.</li>
                  <li>
                    Modal background overlay and high-contrast backdrop scrims.
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#f2e0d2] text-[#2f2d32] border border-[#f2e0d2] space-y-2 shadow-md">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-mono font-black text-sm text-[#2f2d32]">
                      LIGHT ORANGE (#f2e0d2)
                    </span>
                  </div>
                ...
                <ul className="list-disc list-inside text-xs font-sans text-[#2f2d32]/90 space-y-1 pt-1">
                  <li>
                    Main writing workspace canvas background (simulates warm
                    literary bond paper).
                  </li>
                  <li>
                    Typography and icon color inside the Dark Grey sidebars and
                    productivity dock.
                  </li>
                  <li>
                    Soft borders (10-15% opacity) creating clean separation
                    between structural panels.
                  </li>
                  <li>
                    Active document item highlight card in the left sidebar.
                  </li>
        ...
        <div className="p-4 border-t border-[#f2e0d2]/10 bg-[#2f2d32] flex items-center justify-between text-xs font-mono">
          <span className="text-[#f2e0d2]/60">
            Rite Product Design System • /dashboard
          </span>
          <button
            onClick={onClose}
