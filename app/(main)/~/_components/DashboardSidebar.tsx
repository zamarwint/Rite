...
import { DocumentEntry, SupabaseClaims, WorkspaceFolder } from '@/types/types';
              ...
              return (
                ...
                >
                  ...
                  <Button
                    ...
                    variant='ghost'
                    size='icon'
                    className={cn('', isActive ? 'bg-transparent hover:bg-foreground text-transparent hover:text-primary' : 'bg-transparent hover:bg-background text-transparent hover:text-primary')}
                    title="Delete Draft"
                  >
